...
export const INITIAL_APPLICATIONS: ResearchApplication[] = [
...

  {
    ...
    applicantName: 'นายทินกรณ์ หาญณรงค์',
    ...
    deptCode: '01(9)',
    docRunningNo: '201',
    internalDocNo: 'อว 0603.10.01(9)/201',
    ...
    coordinatorNotes: 'คำขอของนักวิจัยบัญชี NU Login (นายทินกรณ์ หาญณรงค์) เอกสารครบถ้วน รอเจ้าหน้าที่วิจัยตรวจสอบฐานข้อมูล',
    lineNotified: true,
